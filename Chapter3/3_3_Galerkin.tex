...
\section{The Galerkin Method}\label{sec:stab_methods}
\vspace{-1ex}
...
%    \href{https://chrome.google.com/webstore/detail/mendeley-web-importer/dagcmkpagjlhakfdhnbomgmjdpkdklff?hl=en}{Mendeley   Web Importer} also has a Google Chrome extension where you can add
