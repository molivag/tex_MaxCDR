\author            {Marco Antonio Oliva Gutierrez}
% \title             {Stabilized Nodal-Based Finite Element Solution for Diffusion-Reaction Maxwell Equations}
\title            {Stabilized Nodal-based Finite Element Solution for Maxwell Equations in Dispersive Media}
...
\burl{https://www.scribbr.com/dissertation/acknowledgements/}.}
 ...
 \begin{tabularx}{\textwidth}{llX}
     ...
     \textbf{MVAF} & - & \textbf{M}ixed \textbf{V}ariational \textbf{A}ugmented \textbf{F}ormulation\\
     \bottomrule
 \end{tabularx}%
 }
...
%     \begin{tabularx}{\textwidth}{llX}
%         \toprule
%         API   & \emph{Application Programming Interface} & - Interface de Programación de Aplicaciones. \\
%         HTML  & \emph{HyperText Markup Language} & - Lenguaje de Marcado de Hipertexto. \\
%         CSS   & \emph{Cascading Style Sheets} & - Hojas de Estilo en Cascada. \\
%         \bottomrule
%     \end{tabularx}
% }
...
\committeeChair         {Ramon Codina} % Graduate Advisor
\advisorTitle           {Associate Professor, Associate Chair}

\committeeMemberII      {Pilar Deus Queralt Adeva}
\committeeMemberIII     {Pedro Diez Mejía}
\committeeMemberIIII    {Irene Áriaz}
