...
%                           References
%----------------------------------------------------------------------%
  \addbibresource{\subfix{Chapter1/bib_files/bibliography1.bib}}
  \addbibresource{\subfix{Chapter2/bib_files/bibliography2.bib}}
  \addbibresource{\subfix{Chapter3/bib_files/bibliography3.bib}}
  % \addbibresource{\subfix{Chapter4/bib_files/bibliography4.bib}}
  % \addbibresource{\subfix{Chapter5/bib_files/bibliography5.bib}}
  % \addbibresource{\subfix{Chapter6/bib_files/bibliography6.bib}}
\raggedbottom
\begin{document}
    ...
    %----------------------------------------------------------------------%
    % \part*{Example Thesis/Dissertation \\{\large(\textcolor{blue}{\texttt{Page not included in actual document}})}} % Only used for organization
    %----------------------------------------------------------------------%
...
%    
     ...
     \subfile{\subfix{Chapter6/Chapter6}}
%%    
%%    %----------------------------------------------------------------------%
